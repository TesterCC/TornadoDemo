...
class HomeHandler(tornado.web.RequestHandler):
    ...
    def get(self, *args, **kwargs):
        ...
        self.render('login.html', error="", message="<h1>test</h1>", list=[1, 2 ,3])

class OtherHandler(tornado.web.RequestHandler):
    def get(self, *args, **kwargs):
        raise tornado.web.HTTPError(status_code=416, log_message='testing', reason='unkown request, please visit 127.0.0.1:8888/')
